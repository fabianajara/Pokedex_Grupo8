document.addEventListener("DOMContentLoaded", function () {
  ...
  const friendsButton = document.getElementById("friendsButton"); // Botón Mis amigos
  ...
  if (user) {
      ...
      // Mostrar los botones de "Pokemones" y "Mis amigos"
      pokemonesButton.classList.remove("hidden");
      friendsButton.classList.remove("hidden"); // Mostrar el botón Mis amigos
      ...
      // Asegurarse de que el botón de "Pokemones" y "Mis amigos" estén ocultos
      pokemonesButton.classList.add("hidden");
      friendsButton.classList.add("hidden");
  }
});